        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                ...
                suffixIcon: const Icon(Icons.check_circle,color: Colors.greenAccent,
                )
            )
          ),
          SizedBox(
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${UpdateCartCubit.get(context).total} EGP',
                style: Styles.textstyle12,
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              Text(
                'Total:',
                style: Styles.textstyle19.copyWith(color: kSecondaryColor),
              ),
              Text(
                '${UpdateCartCubit.get(context).total} EGP',
              style: Styles.textstyle19.copyWith(color: kSecondaryColor),
