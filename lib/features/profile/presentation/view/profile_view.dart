...
import 'package:our_store/features/orders/presentation/view/order_history_view.dart';
          ...
          children: [
            ...
            Column(
              children: [
                ...
                CustomSelectionProfile(icon: Icons.history, text: 'Order History', onTap: () { Get.to(const OrderHistoryView()); },),
